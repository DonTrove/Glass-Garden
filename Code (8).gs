/**
 * Don Trove — Google Apps Script Backend (Green Theme Version)
 * =============================================================
 *
 * HOW TO DEPLOY:
 *  1. Go to https://script.google.com → New Project
 *  2. Paste this entire file
 *  3. Replace SPREADSHEET_ID below with your new Google Sheet's ID
 *     (the long string in the sheet URL between /d/ and /edit)
 *  4. Click Deploy → New Deployment → Web App
 *     - Execute as: Me
 *     - Who has access: Anyone
 *  5. Copy the deployment URL and paste it into app.js → CONFIG.SHEET_URL
 *
 * SHEET STRUCTURE — Products tab:
 *   Name | Price | Description | Image 1 | Image 2 | Image 3 | Image 4 | Image 5 | Category | Active | Colors | Sizes
 *
 *   Image 1–5: One image URL per column. Leave blank or write NO if unused.
 *   Colors:    Comma-separated color names, e.g. Red,Navy Blue,#F5C2D0
 *   Sizes:     Comma-separated label:price pairs, e.g. A5:500,A4:800,A3:1200
 *              Leave blank or write "none" if no size options.
 *   Active:    YES to show the product, NO to hide it.
 *
 * SHEET STRUCTURE — Orders tab (auto-created on first order):
  ...
  try {
    ...
    const products = rows.slice(1)
      ...
      .map(row => {
        ...
        // ── Sizes: "A5:500,A4:800" → [{label:"A5", price:500}, ...]
