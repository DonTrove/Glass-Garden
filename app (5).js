 ...
 *
 * ⚠️  REPLACE THE SHEET_URL below with your new Google Apps Script deployment URL
 */
...
function renderCart() {
  ...
  list.innerHTML = cart.map((item, i) => {
    ...
    return `
    <div class="cart-item" style="flex-wrap:wrap;align-items:flex-start;${needsAttention ? 'border-color:rgba(24,57,43,0.35);' : ''}">
      ...
      <div class="cart-item-info" style="flex:1;min-width:160px;">
        ...
        ${sizesHtml}
        ${colorHtml}
        ${needsAttention ? `<div style="font-size:0.75rem;color:var(--forest);margin-bottom:6px;">✦ Please select your options above</div>` : ""}
        <div class="qty-ctrl">
      ...
      <div style="text-align:right;flex-shrink:0;">
        <div style="font-weight:700;color:var(--forest);margin-bottom:8px;">PKR ${(Number(item.price) * item.qty).toLocaleString()}</div>
...
function showToast(msg, isError = false) {
  ...
  toast.style.borderLeftColor = isError ? "#c0392b" : "#B8A96A";
